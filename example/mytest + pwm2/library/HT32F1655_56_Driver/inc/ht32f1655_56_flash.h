...
#ifndef __HT32F1655_56_FLASH_H
#define __HT32F1655_56_FLASH_H
...
#define FALSH_WP_PAGE_SET(OP, PAGE)     (OP.WriteProtect[PAGE / 64] |= 1 << ((PAGE % 64) / 2))
#define FALSH_WP_PAGE_CLEAR(OP, PAGE)   (OP.WriteProtect[PAGE / 64] &= ~(1 << ((PAGE % 64) / 2)))
#define FALSH_IS_WP_PAGE(OP, PAGE)      (OP.WriteProtect[PAGE / 64] & (1 << ((PAGE % 64) / 2)))
#define FALSH_WP_ALLPAGE_SET(OP)        {u32 i; for (i = 0; i < 3; i++) { OP.WriteProtect[i] = 0xFFFFFFFF; } }
