...
{	 
  ...
  NVIC_InitTypeDef NVIC_InitStructure;
	...
	TIM_TimeBaseStructure.TIM_Prescaler =1439; 	//预分频器   
	...
	TIM_ITConfig(TIM6,TIM_IT_Update,ENABLE);//允许更新中断 ,允许CC1IE捕获中断	
  TIM_Cmd(TIM6,ENABLE); 	//使能定时2
}
