...
{  							  
	...
	{   
		...
		{			    
			...
			else if(mode==0)LCD_Fast_DrawPoint(x,y,GREEN);//BACK_COLOR  BLUE
			temp<<=1;
			y++;
...
void ili9320_chuxianshi(void)
{	
  LCD_Clear(GREEN);
	POINT_COLOR=RED;
	LCD_DrawLine(5, 5, 235, 5);
	LCD_DrawLine(5, 5, 5, 315);
	LCD_DrawLine(5, 315, 235, 315);
	LCD_DrawLine(235, 5, 235, 315);
	LCD_DrawLine(5, 65, 235, 65);
	LCD_DrawLine(5, 130, 125, 130);
	LCD_DrawLine(5, 210, 235, 210);
	LCD_DrawLine(5, 178, 235, 178);
	LCD_DrawLine(5, 240, 235, 240);
	LCD_DrawLine(125, 65, 125, 178);
	POINT_COLOR=BLUE;
	LCD_ShowString(53,28,200,16,16,"   2016-06-05  Sunday ");	   
	LCD_ShowString(70,48,200,16,16,"           :  :   ");
	POINT_COLOR=RED;
	LCD_ShowString(80,10,200,16,16,"www.holtek.com");
	LCD_ShowString(11,28,200,16,16,"  Data: ");
	LCD_ShowString(28,48,200,16,16,"GPS---Time:  ");
	LCD_ShowString(8,70,200,16,16,"instantaneous:");	
	LCD_ShowString(8,86,200,16,16,"    speed:");
	LCD_ShowString(8,105,200,16,16,"         m/s");
	LCD_ShowString(8,135,200,16,16,"Average speed:");
	LCD_ShowString(8,155,200,16,16,"          m/s ");	
	LCD_ShowString(48,185,200,16,16,"Top_speed:      m/s");
	LCD_ShowString(48,220,200,16,16,"Mile:          KM  ");
	LCD_ShowString(18,250,200,16,16,"Temperature:       C     ");
	LCD_ShowString(22,270,200,16,16,"Dampness:         %      ");
	LCD_ShowString(28,290,200,16,16,"visibility:       KM  ");
	LCD_ShowString(135,95,200,16,16,"           ");
	LCD_ShowString(135,115,200,16,16,"            ");
	LCD_ShowString(135,135,200,16,16,"            ");
	LCD_ShowString(128,155,200,16,16,"energy:     %");
