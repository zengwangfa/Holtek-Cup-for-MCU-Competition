...
void I2C_Init(HT_I2C_TypeDef* I2Cx, I2C_InitTypeDef* I2C_InitStruct)
{
  ...
  I2Cx->SHPGR = (PCLK_Freq * 9)/(I2C_InitStruct->I2C_Speed * 20) - uTmp;
  I2Cx->SLPGR = (PCLK_Freq * 11)/(I2C_InitStruct->I2C_Speed * 20) - uTmp;
}
